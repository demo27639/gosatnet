  ...
  head: () => ({
    meta: [
      { title: "Services — Wi-Fi, Internet, Streaming & Cable Help | Gosatnet" },
      {
        name: "description",
        content:
          "Explore third-party assistance: Wi-Fi setup, connectivity guidance, streaming help, and device support from the Gosatnet platform.",
      },
      { property: "og:title", content: "Services — Gosatnet" },
      {
        property: "og:description",
        content: "Premium third-party informational assistance services.",
      },
    ],
  }),
...
const services = [
  {
    icon: Globe,
    title: "Internet Connectivity Guidance",
    desc: "Understand connectivity behavior, modem indicators, and common setup considerations.",
    points: [
      "Connection diagnostic tips",
      "Modem indicator explanations",
      "Speed-related guidance",
    ],
    size: "lg",
    img: heroNetImg,
  },
  {
    icon: Wifi,
    title: "Wi-Fi Setup Support",
    desc: "Help with Wi-Fi configuration, signal placement, and home network basics.",
    points: ["Router placement tips", "Network naming guidance", "Channel & frequency basics"],
    size: "md",
    img: routerImg,
  },
  {
    icon: Tv,
    title: "Streaming Device Assistance",
    desc: "Setting up smart TVs, streaming sticks, and entertainment apps.",
    points: ["Device walkthroughs", "App setup guidance", "HDMI & source basics"],
    size: "md",
  ...
  },
  {
    ...
    desc: "Information about cable services, configuration concepts, and terminology.",
    points: ["Terminology explained", "Configuration concepts", "Setup guidance"],
    size: "md",
    img: streamImg,
  },
  {
    ...
    desc: "Connecting routers, extenders, and smart devices to your home network.",
    points: ["Router walkthroughs", "Extender placement", "Smart device pairing"],
    size: "md",
    img: globeImg,
  },
  {
    ...
    desc: "Help understanding how phones, tablets, and computers connect.",
    points: ["Multi-device basics", "Network switching", "Troubleshooting tips"],
    size: "lg",
    img: teamImg,
  },
];
...
function ServicesHero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        className="absolute -top-40 right-1/4 w-[600px] h-[600px] rounded-full opacity-20 blur-3xl"
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-8">
            ...
            <h1 className="font-display text-4xl md:text-6xl font-bold tracking-tight leading-[1.02]">
              ...
              <br />
              for every connectivity concern
            </h1>
            <p className="mt-6 text-base md:text-lg text-muted-foreground max-w-2xl">
              Six independent informational services — designed for modern households and small
              businesses, delivered with transparent, plain-language guidance.
            </p>
          </div>
          <div className="lg:col-span-4 grid grid-cols-3 gap-2">
            {[Wifi, Tv, Router, Globe, Smartphone, HeadphonesIcon].map((Icon, i) => (
              <div
                key={i}
                className="aspect-square rounded-2xl glass gradient-border flex items-center justify-center"
              >
        ...
        {services.map((s, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, color-mix(in oklab, var(--background) 25%, transparent) 0%, color-mix(in oklab, var(--background) 55%, transparent) 45%, color-mix(in oklab, var(--background) 95%, transparent) 100%)",
              }}
            />
            <div className="absolute inset-x-0 top-0 h-px hairline-top" />

            <span className="absolute top-4 right-4 text-[11px] font-mono tracking-[0.25em] text-foreground/90 glass px-2 py-1 rounded-md backdrop-blur-md">
              0{i + 1}
            </span>
            <div
              className="absolute top-4 left-4 w-12 h-12 rounded-2xl flex items-center justify-center shadow-2xl backdrop-blur-md"
              style={{
            ...
            <div className="relative p-6 md:p-8">
              ...
              <p className="text-sm text-foreground/85 leading-relaxed mb-5 max-w-md drop-shadow">
                {s.desc}
              </p>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-[0.2em] text-primary group-hover:gap-3 transition-all"
              >
                <Phone className="w-3.5 h-3.5" /> Call {SUPPORT_PHONE_DISPLAY}{" "}
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight mb-4">
            A structured, informative workflow
          </h2>
          <p className="text-sm text-muted-foreground mb-8 max-w-xl">
            Every assistance request follows a transparent path designed to be informative — never
            invasive.
          </p>
          <ol className="space-y-3">
            {steps.map((s, i) => (
              <li key={i} className="flex items-start gap-4 glass rounded-2xl p-5 gradient-border">
                <div className="font-mono text-sm font-bold gradient-text shrink-0 w-8">
                  0{i + 1}
                </div>
          ...
          <div className="mt-6 glass rounded-2xl p-4 border-l-2 border-accent flex items-start gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              We never request provider passwords or sensitive credentials. All guidance is
              informational.
            </p>
          </div>
        </div>
        ...
        <div className="relative grid md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7">
            ...
            <p className="mt-3 text-sm md:text-base text-muted-foreground max-w-xl">
              Speak with our independent third-party assistance team today — friendly, patient, and
              always honest about our role.
            </p>
          ...
          <div className="md:col-span-5 grid gap-3">
            <a
              href={SUPPORT_PHONE_TEL}
              className="glass rounded-2xl p-4 corner-frame flex items-center gap-3 hover:bg-card/60 transition-colors"
            >

  ...
  head: () => ({
    meta: [
      { title: "Gosatnet — Premium Internet & Cable Assistance Platform" },
      {
        name: "description",
        content:
          "Get transparent informational guidance for Wi-Fi setup, internet connectivity, streaming, and cable concerns. A premium third-party assistance experience.",
      },
      { property: "og:title", content: "Gosatnet — Internet & Cable Assistance Platform" },
      {
        property: "og:description",
        content:
          "Transparent third-party informational guidance for connectivity, Wi-Fi, streaming, and cable concerns.",
      },
    ],
  }),
  component: HomePage,
...
const services = [
  {
    icon: Wifi,
    title: "Wi-Fi Setup Guidance",
    desc: "Step-by-step support for configuring home and office Wi-Fi networks.",
    img: routerImg,
  },
  {
    icon: Globe,
    title: "Internet Connectivity Help",
    desc: "Guidance for understanding connectivity behavior and modem indicators.",
    img: heroNetImg,
  },
  {
    icon: Tv,
    title: "Streaming Assistance",
    desc: "Help with streaming devices, apps, and home entertainment setup.",
    img: streamingHomeImg,
  },
  {
    icon: Router,
    title: "Device Connection Support",
    desc: "Pairing routers, extenders, and smart devices on home networks.",
    img: globeImg,
  },
  {
    icon: HeadphonesIcon,
    title: "Cable Information Support",
    desc: "Information on cable services, terminology, and configuration concepts.",
    img: streamImg,
  },
  {
    icon: Smartphone,
    title: "Multi-Device Guidance",
    desc: "Support across phones, tablets, laptops, and smart TVs.",
    img: teamImg,
  },
];
...
const faqs = [
  {
    q: "Are you an Internet Service Provider (ISP)?",
    a: "No. Gosatnet is a third-party assistance platform. We do not provide internet, cable, or telecom services and we are not affiliated with any provider.",
  },
  {
    q: "Do you sell internet or cable plans?",
    a: "No. We offer informational guidance only. Service plans must be purchased directly from your provider of choice.",
  },
  {
    q: "Are your assistance fees separate from provider charges?",
    a: "Yes. Our service fees are completely separate. Your provider continues to bill you directly for their own services.",
  },
  {
    q: "Will my provider still bill me?",
    a: "Yes. Your existing provider relationship and billing remain entirely between you and them.",
  },
  {
    q: "Do you ever request my provider passwords?",
    a: "Never. We do not request, collect, or store provider account passwords or sensitive credentials.",
  },
  {
    q: "Am I eligible for a refund?",
    a: "Refund requests are reviewed within 7–15 days of payment based on assistance type and completion status. See our Refund Policy for full details.",
  },
];
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div
        className="absolute -top-32 left-1/2 -translate-x-1/2 w-[1100px] h-[1100px] rounded-full opacity-30 blur-3xl pointer-events-none"
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-20 md:pt-28 pb-12">
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 animate-[fade-up_0.8s_ease-out]">
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-[4rem] leading-[1.02] md:leading-[0.98] tracking-tight">
              Connectivity,
              <br />
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl">
              A premium third-party assistance platform — friendly, transparent informational
              guidance for Wi-Fi, internet, streaming and cable concerns. Never your provider,
              always on your side.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                ...
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-primary-foreground glow-teal transition-all hover:scale-[1.02]"
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground font-mono uppercase tracking-[0.18em]">
              <span className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary" /> No password requests
              </span>
              <span className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-accent" /> No provider affiliation
              </span>
              <span className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-primary" /> Plain-language guidance
              </span>
            </div>
          </div>
    ...
    <div className="relative max-w-[520px] mx-auto">
      ...
      <div className="relative rounded-[2rem] overflow-hidden gradient-border shadow-2xl">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, transparent 40%, color-mix(in oklab, var(--background) 80%, transparent))",
          }}
        />
      ...
      <div
        className="absolute -right-5 top-1/3 glass-strong rounded-2xl p-3 animate-float hidden md:flex items-center gap-2 corner-frame"
...
function HeroStatRibbon() {
  ...
  return (
    <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 rounded-3xl glass-strong overflow-hidden divide-x divide-y md:divide-y-0 divide-border/50 gradient-border">
      {ribbon.map((r) => (
        <div key={r.l} className="p-4 sm:p-5 md:p-6 flex items-center gap-3 sm:gap-4">
          <div
          ...
          <div className="min-w-0">
            <div className="text-xl sm:text-2xl md:text-3xl font-display font-bold gradient-text leading-none">
              {r.v}
            </div>
            <div className="text-[10px] sm:text-[11px] uppercase tracking-[0.16em] text-muted-foreground mt-1 truncate">
              {r.l}
            </div>
          </div>
        </div>
  ...
  const pillars = [
    {
      ...
      d: "Clear communication about who we are, what we do, and what we don't.",
    },
    {
      icon: Compass,
      t: "Guidance, not gatekeeping",
      d: "Patient, plain-language advice from independent advisors.",
    },
    {
      icon: Zap,
      t: "Around the clock",
      d: "Reach our team any time — connectivity questions don't wait.",
    },
  ];
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div className="grid md:grid-cols-3 gap-4">
        {pillars.map((p, i) => (
          <div
            key={p.t}
            className="relative glass rounded-2xl p-7 hover:border-primary/40 transition-colors"
          >
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-5">
          ...
          <h2 className="text-2xl md:text-4xl font-bold tracking-tight">
            A clear, friendly path through everyday connectivity questions
          </h2>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Gosatnet is a third-party assistance platform. We help you understand setup steps,
            troubleshoot common scenarios, and learn best practices — without ever pretending to be
            your provider.
          </p>
        ...
        <div className="lg:col-span-7 relative">
          <img
            src={advisorImg}
            alt="Gosatnet advisor at workstation"
            loading="lazy"
            width={1280}
            height={896}
            className="rounded-3xl border border-border/50 shadow-2xl"
          />
        </div>
      </div>
    </section>
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div className="max-w-2xl mb-10">
        ...
        <h2 className="text-2xl md:text-4xl font-bold tracking-tight">
          What we do — and what falls outside our role
        </h2>
      </div>
      <div className="rounded-3xl glass-strong overflow-hidden divide-y divide-border/50">
        ...
        {items.map((it, i) => (
          <div
            key={i}
            className="grid grid-cols-2 px-6 py-4 text-sm hover:bg-card/30 transition-colors"
          >
            <div className="flex items-start gap-2 pr-4">
              <CheckCircle2 className="w-4 h-4 text-primary shrink-0 mt-0.5" /> {it.good}
            </div>
            <div className="flex items-start gap-2">
              <XCircle className="w-4 h-4 text-destructive shrink-0 mt-0.5" /> {it.bad}
            </div>
          </div>
        ))}
      </div>
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-6 py-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
        <div>
          <p className="text-xs uppercase tracking-[0.25em] text-primary mb-3 font-semibold font-mono">
            / Services
          </p>
          <h2 className="text-2xl md:text-4xl font-bold tracking-tight max-w-2xl">
            Premium third-party support across modern home connectivity
          </h2>
        </div>
        <Link
          to="/services"
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, color-mix(in oklab, var(--background) 20%, transparent) 0%, color-mix(in oklab, var(--background) 60%, transparent) 50%, color-mix(in oklab, var(--background) 95%, transparent) 100%)",
                }}
              />
              <div className="absolute inset-x-0 top-0 h-px hairline-top" />

              <span className="absolute top-4 right-4 text-[11px] font-mono text-foreground/90 tracking-[0.2em] glass px-2 py-1 rounded-md backdrop-blur-md">
                0{i + 1}
              </span>
              <div
                className="absolute top-4 left-4 w-11 h-11 rounded-2xl flex items-center justify-center shadow-xl backdrop-blur-md"
                style={{
              ...
              <div className="relative p-6 md:p-7">
                <h3
                  className={`font-semibold mb-2 drop-shadow-lg ${featured ? "text-xl md:text-3xl" : "text-base md:text-lg"}`}
                >
                  {s.title}
                </h3>
                <p className="text-sm text-foreground/85 leading-relaxed drop-shadow max-w-md">
                  {s.desc}
                </p>
...
function ProcessRail() {
  const steps = [
    ...
    {
      n: "04",
      t: "Apply at your pace",
      d: "Use the suggestions on your own terms — we never log in.",
    },
  ];
  return (
    <section className="relative py-20 overflow-hidden">
          ...
          <div className="grid md:grid-cols-4 gap-5">
            {steps.map((s) => (
              <div key={s.n} className="relative">
                <div className="w-16 h-16 rounded-2xl glass-strong flex items-center justify-center text-xl font-display font-bold gradient-text mb-4 mx-auto md:mx-0">
                  {s.n}
                </div>
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-3">
            {[
              { icon: Users, t: "Friendly advisors" },
              { icon: Clock, t: "Always available" },
            ].map((r) => (
              <div key={r.t} className="flex items-center gap-3 text-sm text-muted-foreground">
                <r.icon className="w-4 h-4 text-primary" /> {r.t}
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="space-y-3">
        {faqs.map((f, i) => (
          <div key={i} className="glass rounded-2xl overflow-hidden">
            ...
            {open === i && (
              <div className="px-5 pb-5 text-sm text-muted-foreground leading-relaxed animate-[fade-in_0.3s_ease-out]">
                {f.a}
              </div>
            )}
          </div>
    ...
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="relative overflow-hidden rounded-[2rem] glass-strong gradient-border">
        <img
          ...
          alt=""
          aria-hidden
          className="absolute inset-0 w-full h-full object-cover opacity-20 radial-mask"
          loading="lazy"
        />
        <div className="absolute inset-0" style={{ background: "var(--gradient-glow)" }} />
        <div
          className="absolute -top-32 -right-24 w-96 h-96 rounded-full opacity-30 blur-3xl"
          style={{ background: "var(--gradient-primary)" }}
        />
        ...
        <div className="relative grid lg:grid-cols-12 gap-8 p-8 md:p-14 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="mt-5 text-muted-foreground max-w-2xl">
              Connect with our independent assistance team for clear, friendly informational
              guidance — no gatekeeping, no upsells.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href={SUPPORT_PHONE_TEL}
                className="px-6 py-3 rounded-xl font-medium text-primary-foreground glow-teal inline-flex items-center gap-2"
                style={{ background: "var(--gradient-primary)" }}
              >
                <Phone className="w-4 h-4" /> Call {SUPPORT_PHONE_DISPLAY}{" "}
              ...
              <Link
                to="/contact"
                className="px-6 py-3 rounded-xl font-medium glass hover:bg-card/80 inline-flex items-center gap-2"
              >
                <MessageSquare className="w-4 h-4" /> Request Guidance
              </Link>
            </div>
            <p className="mt-4 text-xs text-muted-foreground font-mono uppercase tracking-[0.18em]">
              Third-party informational assistance only
            </p>
          </div>
